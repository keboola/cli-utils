...
use Keboola\Console\Command\CheckProjectWorkspacesState;
use Keboola\Console\Command\DeleteProjects;
use Keboola\Console\Command\DeleteProjectWorkspacesById;
...
use Keboola\Console\Command\DownloadComponentConfigurations;
use Keboola\Console\Command\DownloadProjectConfigurations;
...
$application->add(new CheckProjectWorkspacesState());
$application->add(new DeleteProjectWorkspacesById());
...
$application->add(new DownloadComponentConfigurations());
$application->add(new DownloadProjectConfigurations());
$application->run();
